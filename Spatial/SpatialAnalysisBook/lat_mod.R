...
###################################################
library(rgdal)
NY8 <- readOGR("./Desktop/R/Spatial/SpatialAnalysisBook/NY_data", "NY8_utm18")
TCE <- readOGR("./Desktop/R/Spatial/SpatialAnalysisBook/NY_data", "TCE")
library(spdep)
NY_nb = read.gal("./Desktop/R/Spatial/SpatialAnalysisBook/NY_data/NY_nb.gal", region.id=row.names(NY8))
cities <- readOGR("./Desktop/R/Spatial/SpatialAnalysisBook/NY_data", "NY8cities")
