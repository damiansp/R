...
# Cellular automaton
# if specified, init must be vector length "size" whose values must all be from 
# {0, 1, 2}
cell.aut <- function( 
    size=300, A=c(0, 0), B=c(0, 1), C=c(0, 2), D=c(1, 0), E=c(1, 1), G=c(1, 2), 
    H=c(2, 0), I=c(2, 1), J=c(2, 2), init=NULL) { 
