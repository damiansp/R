...
plot(ct1, residuals = T, pch = 16, cex = 0.4)
  ...
  # Default smoother is thin plate regression splines, good but costly for
  # large data sets; change to penalized cubic regression splines:
  ...
  # By default k = 10, which controls the upper bound of possible dfs allowed
  # per  parameter
